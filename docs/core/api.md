...
Подробную спецификацию см. в разделе [HTTP API Reference](#http-api-reference).
...
```json
{
  ...
  "server_state": {
    ...
    "session_id": "20260119_090000",
    "iteration_count": 5,
    "current_activity": "Выполнение задачи: ..."
  },
  "tasks": {
    "in_progress": 1,
    "completed": 5,
...
### 5. POST /restart
Перезапустить сервер после текущей итерации.
