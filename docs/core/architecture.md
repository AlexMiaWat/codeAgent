...
- `ReviewerAgent` (`src/agents/reviewer_agent.py`) - Специализированный агент для проведения многоуровневой верификации результатов. Реализует интерфейс `IAgent`.
...
- **ReviewerAgent** (`src/agents/reviewer_agent.py`) - Специализированный агент, отвечающий за выполнение многоуровневой верификации результатов, полученных от других агентов. Интегрируется с системой верификации для предоставления комплексной оценки качества.
