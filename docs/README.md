...
**Версия:** 2.5 (После полной ревизии документации)
...
2. **[guides/setup.md](guides/setup.md)** - Установка
3. **[testing/TESTING_GUIDE.md](testing/TESTING_GUIDE.md)** - Тестирование

---

## 🔍 Поиск по темам

**Установка:** [guides/setup.md](guides/setup.md), [guides/API_KEYS_SETUP.md](guides/API_KEYS_SETUP.md)  
**Интеграция:** [integration/cursor_integration.md](integration/cursor_integration.md)  
**Тестирование:** [testing/TESTING_GUIDE.md](testing/TESTING_GUIDE.md)  
**Разработка:** [core/architecture.md](core/architecture.md), [core/api.md](core/api.md)

---

**Обновлено:** 2026-01-23 (ревизия завершена)
