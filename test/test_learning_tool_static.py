"""
Статические тесты для LearningTool - проверка структуры данных, форматов
"""
...
class TestLearningToolStatic:
    ...
    def test_learning_tool_class_attributes(self):
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            # Проверяем наличие ключевых слов в описании (с учетом автоматической генерации CrewAI)
