...
- [x] Выделить `ServerCore` для базового цикла выполнения <!-- Выполнено успешно (8/8 инструкций) - 2026-01-23 13:28:18 --> <!-- Выполняется - 2026-02-05 23:11:44 -->
- [ ] **Внедрение dependency injection и SOLID принципов** - см. docs/planning/task_3_20260123_083422.md <!-- Выполнено успешно (6/8 инструкций) - 2026-01-23 14:38:32 -->
