- [x] **Декомпозиция монолитного server.py (4500+ строк)** - см. docs/planning/task_1_20260123_083422.md <!-- Выполнено - 2026-01-23 09:25:12 --> <!-- Выполняется - 2026-02-05 22:43:25 -->
- [ ] Выделить `ServerCore` для базового цикла выполнения <!-- Выполнено успешно (8/8 инструкций) - 2026-01-23 13:28:18 -->
